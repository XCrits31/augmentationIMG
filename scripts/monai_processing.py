    ...
    for transformation in transformations:
        ...
        if name == "contrast":
            ...
            if all(key in params for key in required_keys):
                ...
                transform_list.append(RandRotate(range_x=range_x, prob=prob, keep_size=1, mode="nearest", padding_mode="zeros"))
            else:
            ...
            if all(key in params for key in required_keys):
                ...
                prob = float(params["prob"])
                transform_list.append(RandZoom(min_zoom=zoom_min, max_zoom=zoom_max, prob=prob, mode="nearest", padding_mode="zeros"))
            else:
